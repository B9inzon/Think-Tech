    ...
    <div className="w-screen text-lg flex items-center justify-center bg-emerald-500">
      <nav className="flex flex-col sm:flex-row items-center justify-between w-[90%] h-full sm:h-20 sm:w-[90%] py-2 ">
        <div className="mb-4 sm:mb-0">
          ...
          >
            <img
              className="rounded-full max-h-12 sm:max-h-16"
              ...
              alt="logo"
            />
            <h1 className="font-semibold text-xl sm:text-xl">Think-Tech</h1>
          </Link>
        </div>
        <div className="w-full sm:w-3/5 text-[#363537] font-black flex flex-col sm:flex-row items-center justify-between content-between gap-6 sm:gap-[6vw]">
          <Link
          ...
          {userData?.user.email ? (
            ...
            >
              <svg
                ...
                width="32" // Ajusta el tamaño del ícono para pantallas pequeñas
                height="32"
                viewBox="0 0 48 48"
                fill="none"
            ...
            //!Login
            <Link
              className="border-emerald-500 border rounded-xl w-28 sm:w-32 text-center hover:scale-[1.2] transition duration-500 ease-in-out"
              href="/login"
            >
              Iniciar sesión
            </Link>
          ...
          {userData?.user.email ? (
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="28" // Ajusta el tamaño del ícono del carrito
                height="28"
                viewBox="0 0 48 41"
                fill="none"
                className="transition duration-500 ease-in-out"
            ...
            <Link
              //!Register
              className="border border-emerald-500 rounded-xl w-28 sm:w-32 text-center hover:scale-[1.2] transition duration-500 ease-in-out"
              href="/register"
            >
              Registrarse
            </Link>
