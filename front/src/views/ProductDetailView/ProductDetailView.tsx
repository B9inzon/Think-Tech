...
//         <div className="flex flex-row h-[80%]  w-[80%] p-4 items-center justify-around rounded-xl border shadow-xl bg-[#fefefe]">
...
//             </div>
//             <div className="flex items-center justify-center w-full p-2  h-[20%]">
//               <button className=" rounded-xl h-[45%] w-[70%] bg-yellow-300 hover:bg-yellow-400 font-bold text-xl hover: transition duration-500 ease-in-out" onClick={handleAddToCart}>Agregar al carrito</button>
//             </div>
//           </div>
//         </div>
//       </div>
